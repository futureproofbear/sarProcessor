...
vlog -sv corefft_shim.v ../corefft_stream_adapter.v corefft_stream_tb.v
vsim -c -gPOINTS=8192 -gIN_HEX=fft_vectors/random_in.hex -gOUT_HEX=rtl_out_stream.hex corefft_stream_tb
run -all
quit -f
