...
vlog -sv corefft_shim.v ../corefft_stream64_adapter_fifo.v corefft_stream64_bp_tb.v
vsim -c -gPOINTS=8192 -gIN_HEX=fft_vectors/random_in.hex -gNXFRM=2 -gBP_ON=4 -gBP_OFF=12 corefft_stream64_bp_tb
run -all
quit -f
