...
vlog -sv corefft_shim.v ../corefft_stream64_adapter.v corefft_stream64_bp_tb.v
vsim -c -gPOINTS=8192 -gIN_HEX=fft_vectors/random_in.hex -gNXFRM=2 corefft_stream64_bp_tb
run -all
quit -f
